    ...
    <View style={[styles.topBar, { backgroundColor: theme.background, borderBottomColor: theme.border }]}>
      <View style={styles.topBarInner}>
        <View style={[styles.searchBar, { backgroundColor: theme.surface, borderColor: theme.border }]}>
          ...
          <Text style={[styles.searchPlaceholder, { color: theme.textDisabled }]}>Search songs, artists, instruments...</Text>
        </View>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  topBar: { height: 56, borderBottomWidth: 0.5, justifyContent: 'center', paddingHorizontal: Spacing.xl },
  topBarInner: { flexDirection: 'row', alignItems: 'center', maxWidth: 1200, alignSelf: 'center', width: '100%' },
  searchBar: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm, borderRadius: Radius.full, borderWidth: 0.5, maxWidth: 480 },
