/**
 * VideoPlayer - shared by ALL instruments. Displays and controls video playback.
...
export function VideoPlayer({ source, style, thumbnailUrl, onTimeUpdate, onPlaybackEnd }: VideoPlayerProps) {
  const player = useVideoPlayer(source, (p) => {
    p.loop = false;
    p.timeUpdateEventInterval = 0.25; // ~4 updates/sec for sync
  });
